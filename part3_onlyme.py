...
Original file is located at
    https://colab.research.google.com/drive/1qhHKZog_gW6Iz32KHKyawMrtzm4MWr3f
"""
...
def load_and_prepare_dataset(dataset_name: str, config_name: str, split: str, rec_num: int = 40) -> tuple:
    ...
    # Extract the necessary number of records
    dataset = dataset.select(range(rec_num))

    # Create a new column 'description' by concatenating all descriptions from 'search_results'
    descriptions = []
    ...
    # Convert dataset to pandas DataFrame to add the new column
...
def augment_prompt(
    ...
    # Extract the descriptions from the results, if available
    ...
    # Combine the text matches into a single string
    source_knowledge = "\n\n".join(text_matches)
